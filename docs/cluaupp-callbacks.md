...
The `CompileRequest` / `CompileArtifact` types in [`support/cluaupp.d.ts`](https://github.com/KartzRbx/CLPP/blob/main/support/cluaupp.d.ts) stay the same shape. Full CLI upgrade (0.4.0): [Update Cluaupp for CL++ 0.4](cluaupp-032).
