...
The `CompileRequest` / `CompileArtifact` types in [`support/cluaupp.d.ts`](https://github.com/KartzRbx/CLPP/blob/main/support/cluaupp.d.ts) stay the same shape. Full CLI upgrade (0.7.0): [Cluaupp 0.7.0](cluaupp-070) and [Update Cluaupp](cluaupp-032).
